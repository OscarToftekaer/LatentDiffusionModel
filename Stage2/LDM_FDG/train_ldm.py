...
def main():
    ...
    checkpoint_best = ModelCheckpoint(
        ...
        dirpath='/depict/users/marcus/shared/LDM_fdg_checkpoints/ldm_fdg_pinaya_it3/',    # Directory to save the checkpoints
        filename='FDG_LDM_pinaya_it3-best-{epoch:02d}-{val_loss:.8f}',
    ...
    checkpoint_periodic = ModelCheckpoint(
        dirpath='/depict/users/marcus/shared/LDM_fdg_checkpoints/ldm_fdg_pinaya_it3/',
        filename='FDG_LDM_pinaya_it3-periodic-{epoch:02d}',
        every_n_epochs=1,
        save_top_k=-1
    )
