...
def reconstruct_image_with_style_transfer(diffusion_model, finetuned_vqvae, subject, device, h5_file_path):
    ...
    patch_loader = DataLoader(grid_sampler, batch_size=2) #t5/6 = 2, t7 = 4
...
# Load the JSON file containing subject information
...
# Output paths
output_base_path = "/depict/users/marcus/shared/style_transfered_images/fdg_pinaya_it3_e144_30_6_5_st"
output_json_path = "/depict/users/marcus/shared/style_transfered_images/fdg_pinaya_it3_e144_30_6_5_st.json"  # Update with the desired output path
