...
from models.ldm_fdg_pinaya import DiffusionModelLightning
...
class DeterministicInference:
    ...
    def run_inference(self, content_image, label_data, forward_timestep=30, num_forward_steps=6, num_reverse_steps=5):
        with torch.no_grad():
...
#fdg_vqvae_checkpoint_path = "/homes/marcus/Dokumenter/LDM_precomputed_latens/checkpoints/vqvae/V5Adversarial_PerceptualBrain-epoch=06-val_loss=0.03412391.ckpt"
finetuned_vqvae_checkpoint_path = "/depict/users/oscar/shared/V3_H2O_FineTune-epoch=59-val_loss=0.02156120.ckpt"
ldm_checkpoint_path = "/depict/users/marcus/shared/LDM_fdg_checkpoints/ldm_fdg_pinaya_it3/FDG_LDM_pinaya_it3-best-epoch=144-val_loss=0.02776413.ckpt"
...
output_nifti_path = "/homes/marcus/Dokumenter/LDM_fdg/inference/same_VAE/pinaya_2/learned_30_6_5_e144_pt6.nii"
