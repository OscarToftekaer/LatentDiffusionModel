...
def reconstruct_image_with_style_transfer(diffusion_model, finetuned_vqvae, subject, device, h5_file_path):
    ...
    patch_loader = DataLoader(grid_sampler, batch_size=4) #t5/6 = 2, t7 = 4
...
ldm_checkpoint_path = "/depict/users/marcus/shared/LDM_precomputed_latens_checkpoints/ldm_h2o_pinaya_it3/h2o_LDM_pinaya_it3-periodic-epoch=407.ckpt"
...
# Output paths
output_base_path = "/depict/users/marcus/shared/style_transfered_images/h2o_pinaya_it3_e407_30_6_5_st"
output_json_path = "/depict/users/marcus/shared/style_transfered_images/h2o_pinaya_it3_e407_30_6_5_st.json"  # Update with the desired output path
