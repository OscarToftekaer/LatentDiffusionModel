...
config_path = '/homes/marcus/Dokumenter/LDM_precomputed_latens/config_folder/vqvae_precompute_config.yaml'
train_path = '/homes/marcus/Dokumenter/splits/h2o_train_list.json'
val_path = '/homes/marcus/Dokumenter/splits/h2o_val_list.json'

# Define output folders
#train_output_folder = "/homes/marcus/Dokumenter/LDM_precomputed_latens/latents_h2o_full/train"
#val_output_folder = "/homes/marcus/Dokumenter/LDM_precomputed_latens/latents_h2o_full/val"

train_output_folder = "/depict/users/marcus/shared/latents_h2o_finetuned/train"
val_output_folder = "/depict/users/marcus/shared/latents_h2o_finetuned/val"

from preprocessing import create_subjects_dataset, create_queue, create_transforms_h2o #create_transforms_AdaIN
...
def main():
    ...
    training_transforms, validation_transforms = create_transforms_h2o(patch_size3d_train, patch_size3d_val)
